...
func (s *Server) Start() error {
	...
	s.mux.HandleFunc("DELETE /api/users/schedule", middleware.Log(handlers.DeleteUserSchedule))
	s.mux.HandleFunc(
		"DELETE /api/users/{id}/weekstart",
		middleware.Log(handlers.DeleteUserWeekStart),
	)
